...
export interface paths {
    ...
    "/api/v1/documents/{document_id}/index": {
        ...
        put?: never;
        /**
         * Generate embeddings and index document into Qdrant (Instructor/Admin only)
         * @description Generates dense embeddings for all document chunks and upserts them into the Qdrant vector index.
         */
        post: operations["index_document_api_v1_documents__document_id__index_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/documents/exam-templates/{exam_template_id}/index-all": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        put?: never;
        /**
         * Batch index all documents for an exam template (Instructor/Admin only)
         * @description Batch indexes all curriculum documents associated with a specific exam template.
         */
        post: operations["index_all_exam_documents_api_v1_documents_exam_templates__exam_template_id__index_all_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/questions": {
        ...
        /**
         * List question items with curriculum and psychometric filters
         * @description Returns a paginated list of question items with child options and rubric details.
         */
        get: operations["list_questions_api_v1_questions_get"];
        put?: never;
        /**
         * Create a new question item with options and rubric (Instructor/Admin only)
         * @description Creates a new multi-type question item in the question bank.
         */
    ...
    "/api/v1/questions/{question_id}": {
        ...
        /**
         * Get question detail with options and rubric items
         * @description Retrieves full question metadata, choices with distractor rationales, and analytical scoring rubric.
         */
        get: operations["get_question_api_v1_questions__question_id__get"];
        /**
         * Update question metadata or validation status (Instructor/Admin only)
         * @description Updates prompt, difficulty, Bloom level, or validation status of a question.
         */
        put: operations["update_question_api_v1_questions__question_id__put"];
        post?: never;
        /**
         * Delete a question item and cascade delete its options (Instructor/Admin only)
         * @description Permanently deletes a question from the question bank.
         */
...
export interface components {
    schemas: {
        ...
        QuestionCreate: {
            ...
            /**
             * Prompt
             * @description Markdown & KaTeX prompt
             */
            prompt: string;
            /** Hint */
            hint?: string | null;
            /**
             * Explanation
             * @description Step-by-step solution derivation
             */
            explanation: string;
            /**
             ...
             * @default []
             */
            options: components["schemas"]["QuestionOptionCreate"][];
            /**
             * Rubric Items
             * @default []
             */
            rubric_items: components["schemas"]["QuestionRubricItemCreate"][];
        };
        ...
        QuestionOptionCreate: {
            ...
            /**
             * Content
             * @description Option text with KaTeX support
             */
            content: string;
            /**
             * Is Correct
             ...
             * @description Diagnostic misconception rationale
             */
        ...
        QuestionRubricItemCreate: {
            /**
             * Criterion
             * @description Scoring criterion step
             */
            criterion: string;
            /**
             * Points
         ...
         * @enum {string}
         */
        QuestionType: "mcq_single" | "mcq_multi" | "numerical" | "free_response" | "derivation_step" | "matching";
        /** QuestionUpdate */
        QuestionUpdate: {
            /** Prompt */
            prompt?: string | null;
            ...
            difficulty?: components["schemas"]["DifficultyLevel"] | null;
            bloom_level?: components["schemas"]["BloomTaxonomy"] | null;
         ...
         * @enum {string}
         */
        ValidationStatus: "draft" | "pending_validation" | "validated" | "rejected" | "flagged";
    };
    responses: never;
    parameters: never;
    requestBodies: never;
...
export interface operations {
    ...
    index_document_api_v1_documents__document_id__index_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    index_all_exam_documents_api_v1_documents_exam_templates__exam_template_id__index_all_post: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    list_questions_api_v1_questions_get: {
        parameters: {
            query?: {
                /** @description Filter by exam template ID */
                exam_template_id?: string | null;
                /** @description Filter by topic ID */
                topic_id?: string | null;
                /** @description Filter by question format */

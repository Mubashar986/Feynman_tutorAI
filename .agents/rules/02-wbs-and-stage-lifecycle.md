...
This rule strictly enforces the development lifecycle for the AI Adaptive Exam Learning Platform. Agents are prohibited from spontaneously writing code without following the Work Breakdown Structure (WBS) and completing the required lifecycle stages.

## WBS-First Execution

The WBS (`.agents/state/roadmap_wbs.md`) is the absolute source of truth for **what gets built**.
...
3. Validate dependencies and blockers (such as pending ADRs) before starting.
...
- **Stage 3 (CS Domain Extraction):**
  - Triggered for: Complex AI, IRT calculations, mastery logic, RAG retrieval schemas, or when requested.
  - Required Artifact: `task_X_Y_cs_concepts.md`.
  - Goal: First-principles mathematical or algorithmic breakdown before writing code.
- **Implementation:**
